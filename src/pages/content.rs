...
const CODER_SCHOOL: [&str; 5] = ["Coder School - Teacher", "July 2022 - June 2024", "Serve as a full-time educator, passionately teaching and empowering fellow students.", "Instructed a diverse range of programming languages, including C++, Rust, Python, Lua, uby, Java, Golang, JavaScript, React, Elixir, and more.", "Mentored and trained fellow teachers to foster a thriving learning environment."];
